...
def predict():
    ...
    return render_template('index.html',
                            pred_tox = ' Toxic comment: {}%'.format(out_tox),
                            pred_sev = ' Severely toxic comment: {}%'.format(out_sev), 
                            pred_obs = ' Obscene comment: {}%'.format(out_obs),
                            pred_ins = ' Insult: {}%'.format(out_ins),
                            pred_thr = ' Threat: {}%'.format(out_thr),
                            pred_ide = ' Identity Hate comment: {}%'.format(out_ide)                        
                            )
